...
def main():
    ...
    inspection_route = [
     [-0.64, 0.87, 0.0, 0.0, -0.0, 1.0],
    [0.59, -2.2, 0.0, 0.0, 1.0, 0.01],
    [-4.48, -2.48, 0.0, 0.72, 0.70, 1.0],
    [-4.66, 0.57, 0.0, 0.00, -0.01, 1.0],
    [-1.77, 0.81, 0.0, 0.70, -0.70, 1.0],
    [-0.97, -2.23, 0.0, 0.48, 0.88, 1.0],
    ]
