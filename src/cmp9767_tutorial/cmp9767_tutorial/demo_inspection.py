...
def main():
    ...
    inspection_route = [
        [0.51, -2.05, 0.0, 0.0, 0.98, 0.18],
        [-0.81, -1.84, 0.0, 0.0, 0.94, 0.31],
        [-3.65, -1.06, 0.0, 0.0, -0.74, 0.66],
        [-4.50, -2.38, 0.0, 0.0, 0.86, 0.49],
        [-4.64, 0.31, 0.0, 0.0, 0.01, 0.99],
        [-4.18, 0.04, 0.0, 0.0, 0.10, 0.99],
        [-2.63, 0.33, 0.0, 0.0, -0.36, 0.92],
        [-0.59, -1.89, 0.0, 0.0, 0.56, 0.82],
        [-0.07, -0.03, 0.0, 0.0, -0.02, 0.99],
    ]
