...
def main():
    ...
    inspection_route = [
        [-0.49, 1.10, 0.0, 0.0, -0.50, 0.86],
        [0.42, -1.91, 0.0, 0.00, 1.00, 0.01],
        [0.09, -1.88, 0.0, 0.0, 0.99, 0.17],
        [-2.89, -0.97, 0.0, 0.0, 0.47, 0.88],  
        [-2.10, 0.36, 0.0, 0.0, 1.00, 0.04],
        [-4.37, 1.07, 0.0, 0.0, -0.81, 0.58],
        [-4.74, -0.42, 0.0, 0.0, -0.36, 0.93],
        [-3.99, -1.51, 0.0, 0.0, -0.80, 0.60],
        [-1.72, 1.04, 0.0, 0.0, -0.64, 0.77],
        [-2.99, -0.76, 0.0, 0.0, -0.30, 0.95],
        [0.40, -2.03, 0.0, 0.0, 0.73, 0.68]
    ]
